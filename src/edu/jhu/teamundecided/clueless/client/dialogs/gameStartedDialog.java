...
public class gameStartedDialog extends JDialog
{
    private JPanel contentPane;
    private JButton _closeButton;

    public gameStartedDialog(ClientAppController cac)
    {
    ...
    {
        cac.getClientApp().getPlayerHandButton().setEnabled(true);
        cac.getClientApp().getNotebookButton().setEnabled(true);
